  ...
  <header role="banner">
    ...
    <div style="display:flex; gap:16px; justify-content:center; flex-wrap:wrap; margin-bottom:8px;">
      <div class="visitor-counter" aria-label="Open PRs being tracked">
        WATCHING: <span class="counter-prs-open">0291</span> OPEN PRS
      </div>
      <div class="visitor-counter" aria-label="PRs that have passed under this watchtower's gaze">
        GAZED UPON: <span class="counter-prs-since">0341</span> PRS
      </div>
      <div class="visitor-counter" aria-label="Last updated">
        UPDATED: <span class="counter-last-updated" id="last-updated-utc">2026-07-13 18:16 UTC</span>
      </div>
    </div>
    <script>
      (function() {
    ...
    <aside class="sidebar" aria-label="Stats and links">
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <div class="stat-grid">
            <div class="stat-box">
              <span class="stat-number warn"><span class="counter-prs-open">0291</span></span>
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <ul style="list-style:none; padding:0; margin:0;">
            ...
            <li style="padding:4px 0; border-bottom:1px solid var(--border)"><a href="https://rainsupreme.github.io/valkey-maze/" target="_blank" rel="noopener noreferrer">Valkey Maze ↗</a></li>
            <li style="padding:4px 0; border-bottom:1px solid var(--border)"><a href="https://valkey.io/slack" target="_blank" rel="noopener noreferrer">Community Slack ↗</a></li>
